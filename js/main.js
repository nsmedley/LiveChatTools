...
function buttonGenerator() {
  ...
  $(".save__update").on("click", function() {
    $(".save__preview canvas").remove();
    html2canvas(document.querySelector(".preview")).then(canvas => {
      document.querySelector(".save__preview").appendChild(canvas);
    });
  });
  ...
  $(".save__download").on("click", function() {
    html2canvas(document.querySelector(".preview")).then(canvas => {
      document.querySelector(".save__preview").appendChild(canvas);
      saveAs(canvas.toDataURL(), "button.png");
    });
  });
  ...
  $("#fontFamily").change(function() {
    ...
    $(this).removeClass();
    $(".generator__preview .preview").removeClass(className);
    $(this).addClass(fontFamily);
    $(".generator__preview .preview").addClass(fontFamily);
  });
...
function guides() {
  $(".navGuides").slick({
    ...
    infinite: true,
    prevArrow:
      '<div class="guidesArrow prev"><i class="fal fa-chevron-circle-left"></i></div>',
    nextArrow:
      '<div class="guidesArrow next"><i class="fal fa-chevron-circle-right"></i></div>'
  });
